            ...
            <ul
               ...
               <c:choose>
                  <c:when test="${param.page<=1}">
                     <li class="page-item  "><a class="page-link"
                        onclick="alert('이전 페이지가 없습니다.');">&lt</a></li>
                  </c:when>
                
                  <c:otherwise>
                     <li class="page-item"><a class="page-link"
                        href="${pageContext.request.contextPath}/Business/viewByBizType?page=${param.page-1}&biz_type=${biz_type}">&lt</a></li>
                  </c:otherwise>
               </c:choose>
               <c:forEach var="i" begin="${paging.startNum}"
                  end="${paging.endPage}" step="1">
                  <li class="page-item"><a class="page-link"
                     href="${pageContext.request.contextPath}/Business/viewByBizType?page=${i}&biz_type=${biz_type}">${i}</a></li>
               </c:forEach>
               ...
               <c:choose>
                  ...
                  <c:when test="${param.page >= paging.endPage }">
                     <li class="page-item  "><a class="page-link"
                        onclick="alert('마지막 페이지 입니다.');">&gt</a></li>
                  </c:when>
                  <c:otherwise>
                     <li class="page-item"><a class="page-link"
                        href="${pageContext.request.contextPath}/Business/viewByBizType?page=${param.page+1}&biz_type=${biz_type}">&gt</a></li>
                  </c:otherwise>
               </c:choose>
            </ul>
